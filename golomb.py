...
# Example usage
# binary_string = "00000000100000000000100001111111111111111000000001111111010000000011"
# compression_stats = calculate_golomb_and_stats(binary_string)
# print(compression_stats)

##################################another if the user entered binary and clculate the decimal (tari2et elsokay)###################################
# def binary_to_decimal(binary_string):
#     """Converts a binary string to decimal."""
#     return int(binary_string, 2)

# def calculate_golomb_for_binary(binary_string):
#     """Calculates Golomb encoding for a binary string."""
#     decimal_value = binary_to_decimal(binary_string)
#     m = round(math.sqrt(decimal_value))
#     return golomb(decimal_value, m)

# # Example usage
# binary_string = "101010"
# golomb_stats = calculate_golomb_for_binary(binary_string)
# print(golomb_stats)
